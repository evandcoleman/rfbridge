...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='rfbridge',
  syntax='proto3',
  serialized_pb=_b('\n\x0erfbridge.proto\x12\x03\x66\x61n\"/\n\x0e\x43ommandRequest\x12\x1d\n\x07\x63ommand\x18\x01 \x01(\x0e\x32\x0c.rfbridge.Command\"\x11\n\x0f\x43ommandResponse*K\n\x07\x43ommand\x12\t\n\x05LIGHT\x10\x00\x12\x08\n\x04STOP\x10\x01\x12\x08\n\x04SLOW\x10\x02\x12\n\n\x06MEDIUM\x10\x03\x12\x08\n\x04\x46\x41ST\x10\x04\x12\x0b\n\x07REVERSE\x10\x05\x32\x46\n\x08RFBridge\x12:\n\x0bSendCommand\x12\x13.rfbridge.CommandRequest\x1a\x14.rfbridge.CommandResponse\"\x00\x62\x06proto3')
)
...
CommandRequest = _reflection.GeneratedProtocolMessageType('CommandRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:fan.CommandRequest)
  ))
...
CommandResponse = _reflection.GeneratedProtocolMessageType('CommandResponse', (_message.Message,), dict(
  ...
  __module__ = 'rfbridge_pb2'
  # @@protoc_insertion_point(class_scope:fan.CommandResponse)
  ))
